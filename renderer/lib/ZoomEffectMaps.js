 ...
 */
export function extendMSOGMapWithMS60BEffects(mapForMSOG) {
    let map = new Map();
...
export function extendMapWithMaxNumericalValueIndex(map) {
 ...
 * @param nameMap
 */
export function replaceEffectNamesInMap(effectIDMap, nameMap) {
...
export function addThruEffectToMap(effectIDMap) {
